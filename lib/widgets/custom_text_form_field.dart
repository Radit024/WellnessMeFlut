...
class CustomTextFormField extends StatelessWidget {
  ...
  Widget get textFormFieldWidget => SizedBox(
        ...
        child: TextFormField(
          ...
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.titleMediumUrbanistOnError,
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.bodyMediumRalewayGray50001,
        prefixIcon: prefix,
...
extension TextFormFieldStyleHelper on CustomTextFormField {
  ...
  static OutlineInputBorder get outlineGrayC => OutlineInputBorder(
        borderRadius: BorderRadius.circular(28.h),
